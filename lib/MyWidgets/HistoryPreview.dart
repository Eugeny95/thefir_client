...
class HistoryPreview extends StatefulWidget {
  ...
  HistoryPreview(this.orderObject, {Key? key}) : super(key: key);

  @override
  State<HistoryPreview> createState() => _HistoryPreviewState(orderObject);
}

class _HistoryPreviewState extends State<HistoryPreview> {
  OrderObject? orderObject;
  _HistoryPreviewState(this.orderObject);
  @override
